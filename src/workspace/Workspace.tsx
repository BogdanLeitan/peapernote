          ...
          <article id="folder-personal" className="sheet">
            <div className="page">
              ...
              <div className="editor">
                <p className="muted folder-empty">Folder gol.</p>
              </div>
            </div>
          </article>

          {/* --- Page: Folder Projects --- */}
            ...
            <div className="page">
              ...
              <div className="editor">
                ...
                <div className="subpages">
                  <label className="subpage slot-1" htmlFor="page-note-projects-1"><svg className="ui-icon" aria-hidden="true"><use href="#i-page" /></svg><span>Untitled</span></label>
                  <label className="subpage slot-2" htmlFor="page-note-projects-2"><svg className="ui-icon" aria-hidden="true"><use href="#i-page" /></svg><span>Untitled</span></label>
                </div>
              </div>
            </div>
          </article>

          {/* --- Notes: blank editable pages --- */}
          <article id="note-projects-1" className="sheet note-sheet"><div className="page"><h1 className="page-title" contentEditable="true" suppressContentEditableWarning data-placeholder="Untitled"></h1><div className="editor"><p data-placeholder="Start writing..."></p></div></div></article>
          <article id="note-projects-2" className="sheet note-sheet"><div className="page"><h1 className="page-title" contentEditable="true" suppressContentEditableWarning data-placeholder="Untitled"></h1><div className="editor"><p data-placeholder="Start writing..."></p></div></div></article>
